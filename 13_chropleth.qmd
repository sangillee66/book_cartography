...
my_map <- tm_shape(grat_bb_m, projection = "+proj=robin") + tm_borders(lwd = 1) + 
  ...
  tm_credits("SANG-IL LEE, Geograhy Education at SNU, 2024", size = 0.5, position = c(0.55, 0.02))
my_map
```
...
my_map <- tm_shape(seoul_df) + 
  ...
  tm_scale_bar(
    color.dark = "gray60", text.size = 0.4, breaks = seq(0, 10, 2), position = c(0.03, 0.01)) + 
  tm_credits("SANG-IL LEE, Geograhy Education at SNU, 2024", size = 0.7, position = c(0.79, 0.01))
my_map
```
